const { getAdminCustomer, getAdminResturant, getAdminOrder, registerAdminRider, getAdminRider, updateAdminRider, updateRiderAccount, } = require("../controllers/admin.controller")
