const { getAdminCustomer, getAdminResturant, getAdminOrder, registerAdminRider, getAdminRider, updateAdminRider, updateRiderAccount, getAdminActiveRider, assignRider, } = require("../controllers/admin.controller")
